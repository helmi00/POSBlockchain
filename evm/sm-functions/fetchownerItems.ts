...
export async function fetchownerItems(vm: VM, contractAddress: Address, caller: Address, methodabi: object, id: Number) {

  const sigHash = new Interface([methodabi]).getSighash('fetchownerItems');
