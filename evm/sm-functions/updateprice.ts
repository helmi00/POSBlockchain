...
export async function updateprice(vm: VM, contractAddress: Address, senderPrivateKey: Buffer, tokenId: Number, proposeprice: Number) {
  const data = encodeFunction('updateprice', {
